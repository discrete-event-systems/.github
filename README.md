...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`discrete-event-systems`](https://github.com/discrete-event-systems).

## Canonical organization links

- GitHub organization: https://github.com/discrete-event-systems
- Public organization defaults: https://github.com/discrete-event-systems/.github
