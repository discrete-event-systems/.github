...
- [Linear planning project](https://linear.app/denman/project/githubcomdiscrete-event-systems-4a3086ae0c45)
...
- Canonical Linear project: https://linear.app/denman/project/githubcomdiscrete-event-systems-4a3086ae0c45
- Organization defaults: https://github.com/discrete-event-systems/.github
- Canonical agent policy: https://github.com/discrete-event-systems/.github/blob/main/agents.md
- Security policy: https://github.com/discrete-event-systems/.github/security/policy
...
`discrete-event-systems` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
